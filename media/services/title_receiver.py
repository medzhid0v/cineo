...
def update_or_create_title(user_id: int, title_dto: TitleDTO, seasons_dto: SeasonsDTO) -> tuple[Title, bool]:
    title, created = Title.objects.update_or_create(
        ...
        defaults={
            ...
            "original_name": title_dto.original_name,
            "description": title_dto.description,
            "short_description": title_dto.short_description,
            "slogan": title_dto.slogan,
            "imdb_id": title_dto.imdb_id,
            "rating_kp": title_dto.rating_kp,
            "rating_imdb": title_dto.rating_imdb,
            "age_limit": title_dto.age_limit,
            "genres": title_dto.genres,
            "countries": title_dto.countries,
            "cover_url": title_dto.cover_url,
            "start_year": title_dto.start_year,
            "end_year": title_dto.end_year,
        },
    )
